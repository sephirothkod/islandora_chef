...
<xsl:stylesheet version="1.0"
  ...
  <!-- <xsl:include href="<%= node['tomcat']['webapp_dir'] =%>/fedoragsearch/WEB-INF/classes/config/index/FgsIndex/islandora_transforms/library/xslt-date-template.xslt"/>-->
  <xsl:include href="<%= node['tomcat']['webapp_dir'] =%>/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/islandora_transforms/library/xslt-date-template.xslt"/>
